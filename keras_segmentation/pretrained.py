...
def pspnet_50_ADE_20K():
    ...
    latest_weights = keras.utils.data_utils.get_file("pspnet50_ade20k.h5", model_url)
...
def pspnet_101_cityscapes():
    ...
    latest_weights = keras.utils.data_utils.get_file("pspnet101_cityscapes.h5", model_url)
